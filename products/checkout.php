        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">Kiểm Tra Đơn Hàng</h1>
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Trang Chủ</a></span> <span>Kiểm Tra Đơn Hàng</span></p>
            </div>
			...
			<form action="checkout.php" method="POST" class="billing-form ftco-bg-dark p-3 p-md-5">
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-12">
	                  ...
	                  <input name="street_address" type="text" class="form-control" placeholder="Địa chỉ nhà và tên đường">
	                </div>
		            </div>
		            ...
		            <div class="col-md-12">
		            	<div class="form-group">
		            		<label for="postcodezip">Mã Thành Phố</label>
                ...
                <div class="col-md-12">
					...
					<div class="radio">
                      <p><button type="submit" name="submit" class="btn btn-primary py-3 px-4">Đặt hàng và thanh toán</button></p>
