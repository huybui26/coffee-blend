...
<section class="home-slider owl-carousel">
    ...
    <div class="container">
        ...
        <div class="col-md-7 col-sm-12 text-center ftco-animate">
            <h1 class="mb-3 mt-5 bread">Thanh Toán với PayPal</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo APPURL; ?>">Trang Chủ</a></span> <span>Thanh Toán với PayPal</span></p>
        </div>
