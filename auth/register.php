        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Trang Chủ</a></span> <span>Đăng Ký</span></p>
            </div>
			...
			<form action="register.php" method="POST" class="billing-form ftco-bg-dark p-3 p-md-5">
                ...
                <div class="col-md-12">
                	<div class="form-group mt-4">
							<div class="radio">
                    <button type="submit" name="submit" class="btn btn-primary py-3 px-4">Đăng Ký</button>
						    </div>
					</div>
                </div>
